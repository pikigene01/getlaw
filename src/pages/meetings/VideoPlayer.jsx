...
<button id="call_user_btn" onClick={()=> callUser(idToCall)}><Phone/> <span>Call</span></button>
    ...
    <div className='abs header_phone' onClick={toggleMode} ><div><Notifications/>{messagesUser.length}</div><div><Message/>{messagesUser.length}</div><div><NetworkCell/><small>GenePiki</small></div></div>
